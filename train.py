...
def trainIters(encoder, decoder, n_iters, print_every=1000, plot_every=100, learning_rate=0.01, lang_pack=None):
    ...
    training_pairs = [tensorsFromPair(random.choice(pairs), langs=[input_lang, output_lang])
